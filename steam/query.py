...
class SteamQuery:
    ...
    def _make_challenged_request(self, udpsock, payload_prefix):
        ...
        raise BrokenChallengeError(
            "Server keeps sending new challenges " "instead of accepting."
        )
    ...
    def return_last_data(self):
        ...
        return (
            self.query_game_server() if self.server_info is None else self.server_info
        )
